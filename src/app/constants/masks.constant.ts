...
export const masks: Card[] =
  [

    {
      title: 'Dakine Hunter Balaclava',
      subtitle: 'Gorro para Casco, Color Negro',
    ...
    {
      title: 'GripGrab Pasamontañas Térmico de Ciclismo',
      subtitle: 'Sotocasco Braga de Cuello Invierno Forro Polar Cabeza Hombre Mujer y Niños',
    ...
    {
      title: 'Happyyami Máscaras de Kabuki Japonés de Kitsune Novedad',
      subtitle: 'Fiesta de Disfraces de Halloween para Disfraces de Halloween Suministros para Banquetes ( Y Rojo )',
    ...
    {
      title: 'LHGXQ-Dp Máscara Tobi Blanca Naruto Obito Uchiha, Anime Japonés',
      subtitle: 'Disfraces Fiesta, Accesorios De Disfraces, Máscara De Supervillano, Máscara Película, Cosplay,Blanco,28 * 18CM',
